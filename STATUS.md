...
- Slice 4f (2026-09-07): home is de-tutorialized and desktop-centered. "THE DECK IS THE DOOR" and "PICK A RECIPE AFTER THE DEAL" are gone, the deck object is the tappable primary action with the DEAL caption, LEVEL is spelled out with STREAK hidden at zero, the headline no longer orphans, and desktop gets a centered 840px column with a two-column stage instead of a 300px phone column. Also gated the hub VIEW RULES link, which was painting at full opacity on the home surface (hidden-layer bleed). 22-check home QA at 375x812 and 1440x900 green with zero overflow/errors; 324/324 Jest, lint, and typecheck.

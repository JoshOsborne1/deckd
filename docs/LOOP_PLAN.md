...
2. Make the persistent table canvas explicitly ivory/crimson: move remaining green defaults out of the active surface language while keeping Classic Felt available as an intentional legacy cosmetic.
...
- The active default surface contains no green playing-space treatment; any remaining green is isolated to an explicitly named optional Classic Felt cosmetic.
...
- Do not remove the Classic Felt cosmetic in this pass; neutralize it from the default path and document it as an intentional alternate.

...
export const BUILTIN_CARD_BACKS: CardBackDefinition[] = [
  {
    ...
    name: 'Deckd Crimson',
    family: 'brand',
    asset: 'assets/card-back-deckd.png',
  ...
  },
  {
    ...
    name: 'Noir',
    family: 'ink',
    asset: 'assets/card-back-noir.png',
    palette: ['#1A1A1A', '#333333', '#FDFCFA'],
    unlockedByDefault: true,
  },
  {
    id: 'back-crimson',
    name: 'Crimson',
    family: 'premium',
    asset: 'assets/card-back-crimson.png',
    palette: ['#901A1A', '#B02020', '#FDFCFA'],
    unlockedByDefault: true,
  },
];
